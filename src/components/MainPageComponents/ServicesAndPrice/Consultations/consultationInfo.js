...
const demonOffering1 =
  'Проработка жертвенного состояния; избавления от боли, душевных и физических страданий; гармонизация психологического состояния; ощущение себя на трех уровнях сознания (души, разума и тела) в каждом действии; избавление от того, что тормозит развитие на каждом уровне.';
...
export const cards = [
  ...
  },
  {
    ...
    info: {
      ...
      list: [
        'поможет определиться с дальнейшим направлением в жизни и выбрать специальность для поступления. ',
        'поможет выбрать сферу, которая будет соответствовать задачам предназначения. ',
