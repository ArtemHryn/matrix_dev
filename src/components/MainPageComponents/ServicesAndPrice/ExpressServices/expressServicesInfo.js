...
const textBeforeCard1a =
  'Определяется состояние каждой энергии в матрице на данный момент. Проводиться с помощью карт Метода или карт Таро.Подойдёт для тех, кто раньше уже был на консультации (у меня или другого мастера), находится в трансформации или же разбирал свою матрицу самостоятельно и желает узнать в каком состоянии находятся энергии исходя из запроса. ';
...
const textBeforeCard3b =
  'Красивая дата ≠ благоприятная дата Разберем какие задачи, препятствия, усиления несёт желаемая дата или период. Подберём лучшую дату исходя из запроса.';
...
export const cards = [
  ...
  },
  {
    ...
    price: '$30',
    info: {
      textBefore: [textBeforeCard3a, textBeforeCard3b],
