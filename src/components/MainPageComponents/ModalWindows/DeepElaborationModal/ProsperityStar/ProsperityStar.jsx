...
import { AdditionalInfo, Button, BuyButton, HowIsGoingConsultation, List, ListTitle, MainTitle, Price, Requests, Text } from './ProsperityStar.styled';
...
export const ProsperityStar = ({ setShowModal }) => {
  return (
    <>
