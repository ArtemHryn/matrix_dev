      ...
      <Box display={[null, null, 'flex']} >
        ...
        >
          ...
          <Text mb="15px">
            ...
            глубинных способностей личности. Данный расчёт показывает полный
            сценарий ситуаций в жизни человека и кармические истории, которые
            прорабатываются. В итоге человек получает алмазную огранку матрицы,
            то есть защиту судьбы.
          </Text>
          <Text mb="25px">
